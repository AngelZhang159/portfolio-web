  ...
  return (
    <SectionFrame id='title'>
      <div className='relative z-10 inline-block w-full pb-20 text-center lg:pt-0'>
        <h1 className='bg-linear-to-br from-pink-300 to-blue-300 bg-clip-text text-5xl font-extrabold leading-normal tracking-wide text-transparent lg:text-9xl lg:leading-loose'>
          Angel Zhang
        </h1>
